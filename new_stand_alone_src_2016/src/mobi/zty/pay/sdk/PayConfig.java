...
public class PayConfig {
	 ...
	 * anan联通沃破解支付
	 */
	public static final int WOSMS_PAY = 40;
	/**
	/**
	 * anan联通沃破解支付(在线版本)
	 */
	public static final int WOSMSON_PAY = 65;
	...
	public static String[] appIds = {
		...
		"90211415556", "90211415557" ,"300009568216"};//锤妖记的是联通的，90211415557：暂时没有appid,雷电
	...
	public static String[] appkeys = { 
		...
		"e4a8e6624de894b44238","e4a8e6624de894b44239"                        ,"34611F8EA2A4F5081F16D57C2E78A9CE"};//最后两个凑数的
		...
		switch (payType) {// 根据支付类型返回 shopInfo
			...
			case CMCC_NETIVE_FEE: {// 移动MM的计费
				...
				if(appId.equals("300009183552")){//开心跳跳跳 gameID = 5269
					...
					int[] prices = { 2 * 100, 10 * 100, 10 * 100, 20 * 100, 18 * 100,
							4 * 100, 6 * 100, 18 * 100, 6 * 100, 25 * 100};
					info.setPrice(prices);
				}else if (appId.equals("300009194701")) {//倒霉熊之机甲战神(这个 代码是错误的 以后改)
					info = new ShopInfo();
					info.AppId = appId; 
					...
					info.setPrice(prices);
				}else if(appId.equals("300009568216")){//董卓快跑
					info = new ShopInfo();
					info.AppId = appId; 
			...
			case JD_PAY: {// 移动基地的计费
				if (appId.equals("300009006190")) {
					...
					int[] prices = { 2 * 100,12* 100,2 * 100, 6 * 100,  18 * 100,30 * 100,12 * 100,
							6 * 100,6 * 100,8 * 100,1 * 100,8 * 100,12 * 100,29 * 100,5 * 100};
					String codes[] = { "001", "002", "003", "004", "005", "006", "016", "017", "018", 
					...
					String codes[] = { "010", "011", "012", "013", "014", "019",
							"016", "017", "018"};
					info = new ShopInfo();
					info.setPriceAlone(prices);
					info.setCodeMapAlone(codes);
