...
public class OmpicSharedPreferences extends DefaultHandler{
	...
	public OmpicSharedPreferences(String FilePath)
	{
	...
	public String GenxmlString()
	{
	    ...
	    try { 	
			...
			for(KeyValueData data:m_list)
			{
				...
				{
					xmlUtil.WritexmlTag(xmlSerializer, stringWriter, data.m_Key, data.m_Value, 1);
				}
			}
