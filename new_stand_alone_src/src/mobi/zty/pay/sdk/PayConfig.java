...
public class PayConfig {
	...
	public static String[] appIds = {
		...
		"300008262076","300009189686"};//锤妖记的是联通的，
	...
	public static String[] appkeys = { 
		...
		"90446A601AB6F5D1","DD85CDACE687702C3C85E1638006B530"};//
...
//							"019", "020","021","022","023","024"};
					...
					info.setPriceAlone(prices);
					info.setCodeMapAlone(codes);
				}else if(appId.equals("300009189686")){
					int[] prices = { 20 * 100, 20 * 100, 18 * 100, 6 * 100, 10 * 100,
							8 * 100,4 * 100, 2 * 100,6*100, 10 };
					String codes[] = { "001", "002", "003", "004", "005", "006",
							"007", "008", "009", "010"};
					info = new ShopInfo();
					info.setPriceAlone(prices);
