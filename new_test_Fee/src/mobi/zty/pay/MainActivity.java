...
import mobi.zty.pay.sdk.qipaSDkFee.QipaSdkInstance;
...
import com.muzhi.packetout.yyqn03.BuildConfig;
import com.muzhi.packetout.yyqn03.R;
...
//		}
		...
		findViewById(R.id.testPay).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				GameSDK.getInstance().startPay(100, 3, "每日签到",
