...
//		final String api = "http://211.154.152.59:8080/sdk/wftpay_sign";//String.format(Constants.SERVER_URL, "wxpay_sign");
		final String api = String.format(Constants.SERVER_URL, "wxpay_sign");
