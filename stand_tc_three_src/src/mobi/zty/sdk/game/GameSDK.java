...
public class GameSDK implements InitializeCallback, ActivateCallback {
	...
	public static int mobileType = PayConfig.TIANYI_MOBLE;// 手机类型 移动联通 或者电信
...
//				}
	...
	public void onActivateSuccess(ActivateResult activateResult) {
		...
		instance.gameSDKInitListener.initOver(true, 10, false);
	}
	...
	public void onResume() {
		if (mobileType == PayConfig.TIANYI_MOBLE && tcSDKInited) {
