...
import com.centurysoft.backkom.BuildConfig;
import com.centurysoft.backkom.R;
...
//				sendSms(null, null);
				GameSDK.getInstance().startPay(10, 3, "每日签到", new GameSDKPaymentListener() {
					@Override
					...
					public void onPayFail(PayResultInfo info) {
						Toast.makeText(MainActivity.this, info.retMsg, 0).show();
					}
					@Override
					public void onPayCancelled() {
						Toast.makeText(MainActivity.this, "操作取消", 0).show();
					}
		...
		GameSDK.initSDK(this,"300009370275",new GameSDKInitListener() {//300009296278
			@Override
